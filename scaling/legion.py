"""
Legion-style scaling with exponential secondaries. Note that we still use the
linearization constants to reverse the linearization on the input secondaries,
converting them back into Legion values.
"""
import theano as th
...
def build_points(stats, base):
    ...
    total_snd = budget_scalar * raw_snd
