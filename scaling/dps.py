...
POINTS_PER_PCT = T.dvector('POINTS_PER_PCT')
...
dps = th.function([POINTS_PER_PCT, base_mainstat, base_snds, pct_dist, with_dr, mainstat, snds],
                  dps_res)

dps_grad = th.function([POINTS_PER_PCT, base_mainstat, base_snds, pct_dist, with_dr, mainstat, snds],
                       T.grad(dps_res, snds))
